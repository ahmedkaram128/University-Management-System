...
namespace University_HR_ManagementSystem.Pages
{
    public class LoginEmployeeModel : PageModel
    {
        ...
        public LoginEmployeeModel(ILoginRepository _loginRepository)  {
        ...
        public async Task<IActionResult> OnPost(){
            if (await loginRepository.validateEmpLogin(ID, Password)){                
                ...
                return LocalRedirect("/EmployeeDashboard/EmployeeDashboard");
            }
